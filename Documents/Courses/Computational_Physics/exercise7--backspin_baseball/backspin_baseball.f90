...
! angular velosity omega = 2000rpm, equals to (2000/60)*2Pi rad/s
! time interval delta_t = 0.01s
real(kind=8),parameter :: S_div_m = 4.1E-04, grav_const = 9.8, &
& omega = (2000./60.) * 2. * 3.14159, delta_t = 0.01
...
!  y(1) - r8_y1x ( t )
  ...
  open(10, file="trajectory_of_backspin_baseball", form="formatted",&
